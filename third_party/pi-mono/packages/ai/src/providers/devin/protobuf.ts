...
/** Base64 for `bytes` fields in `toJson` (ES2025 `Uint8Array.toBase64` is not in this target). */
function bytesToBase64(value: Uint8Array): string {
	return Buffer.from(value.buffer, value.byteOffset, value.byteLength).toString("base64");
}

/**
 * High-performance, zero-builder protobuf wire codecs for the Devin proto schemas.
 *
