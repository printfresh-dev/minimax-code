 ...
 */
import { pb, type MessageCodec, type ProtoMessage } from "./protobuf.ts";
...
export type CascadeCommandsAutoExecution = (typeof CascadeCommandsAutoExecution)[keyof typeof CascadeCommandsAutoExecution];
...
export type CortexStepType = (typeof CortexStepType)[keyof typeof CortexStepType];
...
export type CortexTrajectoryType = (typeof CortexTrajectoryType)[keyof typeof CortexTrajectoryType];
...
export type ExperimentKey = (typeof ExperimentKey)[keyof typeof ExperimentKey];
...
export type ExperimentSource = (typeof ExperimentSource)[keyof typeof ExperimentSource];
...
export type ModelCostTier = (typeof ModelCostTier)[keyof typeof ModelCostTier];
...
export type ModelPricingType = (typeof ModelPricingType)[keyof typeof ModelPricingType];
...
export type PromptAnnotationKind = (typeof PromptAnnotationKind)[keyof typeof PromptAnnotationKind];
...
export type PromptTemplaterType = (typeof PromptTemplaterType)[keyof typeof PromptTemplaterType];
...
export const SandboxEnforcementMode = {
	UNSPECIFIED: 0,
	OPTIONAL: 1,
	REQUIRED: 2,
}

export type SandboxEnforcementMode = (typeof SandboxEnforcementMode)[keyof typeof SandboxEnforcementMode];
...
export type TeamsFeatures = (typeof TeamsFeatures)[keyof typeof TeamsFeatures];
...
export type TeamsTier = (typeof TeamsTier)[keyof typeof TeamsTier];
...
export type ToolFormatterType = (typeof ToolFormatterType)[keyof typeof ToolFormatterType];
...
export type UserFeatures = (typeof UserFeatures)[keyof typeof UserFeatures];
